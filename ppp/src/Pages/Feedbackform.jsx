...
export default function Register() {
    ...
    const feedbackRef = useRef(); // Ref for the location input field
 

    const customerRef = collection(firestore, "feedback"); // Reference to the 'customer' collection
...
<path d="M89 35.4999C25.8 -36.1001 -87 19.6666 -135.5 56.4999L-2.5 362.5L359 361.5C351.5 243 234 333.5 213 257C192 180.5 168 125 89 35.4999Z" fill="#FCAE7C"/>
            ...
            <form onSubmit={handleSave}>
                ...
                <div>
                    ...
                    <input type="textarea" ref={feedbackRef} required />
                </div>
                <div></div>
                <div>
